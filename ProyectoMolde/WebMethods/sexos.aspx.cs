...
{
    public partial class sexos : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static Result getListaSexos(int registroPartida, int totalAExtraer, int usuarioId)
        {
            ...
            List<SexosViewModel> lst = new List<SexosViewModel>();
            try
            {
                lst = SexosController.getListaSexos();
        ...
        public static Result eliminar(int id, int usuarioId)
        {
            ...
            try
            {
                return SexosController.eliminarSexos(id, usuarioId);
            }
            catch (Exception ex)
            {
                return new Result() { error = ex.Message, id = 0, tipoAlerta = "warning" };
